...
export default function LandingPage() {
  ...
  return (
    ...
    <StarfieldBackground />
    <div className="min-h-screen text-slate-100 relative overflow-clip font-sans">

      {/* Soft Odoo-purple nebula glows layered over the stars (decorative). */}
      <div className="absolute inset-0 z-0 pointer-events-none">
        <div className="absolute top-[-10%] left-[-10%] w-[50%] h-[50%] rounded-full bg-gradient-to-br from-[#714B67]/25 to-transparent blur-[120px]" />
        <div className="absolute top-[35%] right-[-10%] w-[40%] h-[40%] rounded-full bg-gradient-to-bl from-[#714B67]/15 to-transparent blur-[150px]" />
        <div className="absolute bottom-[-5%] left-[20%] w-[30%] h-[30%] rounded-full bg-[#714B67]/12 blur-[100px]" />
      </div>

      {/* Navigation Bar */}
      <div className="fixed top-6 left-0 right-0 z-50 flex justify-center px-4 md:px-8">
        <nav className="flex items-center justify-between w-full max-w-6xl px-8 py-3.5 rounded-full bg-white/5 backdrop-blur-xl border border-white/10 shadow-lg shadow-black/20">
          <div className="flex items-center gap-2.5">
            <div className="w-8 h-8 rounded-full bg-white/10 border border-white/15 flex items-center justify-center shadow-sm">
              <Box className="w-4 h-4 text-odoo-300" />
            </div>
            <span className="text-xl font-extrabold tracking-tight text-white">AssetFlow</span>
          </div>
          ...
          <div className="flex items-center">
            <Link href="/login" className="bg-white hover:bg-slate-100 px-6 py-2 rounded-full text-sm font-semibold transition-all text-slate-900 shadow-md shadow-black/20">
              Sign In
            </Link>
          </div>
        </nav>
      ...
      <main className="relative z-10 flex flex-col items-center text-center px-4 pt-32 pb-32 max-w-5xl mx-auto">
        ...
        <motion.h1
          ...
          className="text-5xl md:text-7xl font-extrabold tracking-tight mb-6 leading-tight text-white [text-shadow:0_2px_30px_rgba(0,0,0,0.45)]"
        >
          Enterprise Asset & <br className="hidden md:block" />
          <span className="text-odoo-300">
            Resource Management
          </span>
        </motion.h1>
        ...
        >
          <Link href="/login" className="w-full sm:w-auto px-8 py-4 rounded-full bg-gradient-to-r from-[#714B67] to-[#5a3c52] hover:from-[#5a3c52] hover:to-[#714B67] text-white font-bold shadow-lg shadow-[#714B67]/30 transition-all transform hover:-translate-y-0.5">
            Get Started
          </Link>
          <a href="#" className="w-full sm:w-auto px-8 py-4 rounded-full bg-white/5 border border-white/15 hover:bg-white/10 text-white font-bold transition-all shadow-sm backdrop-blur-md">
            View Live Demo
          </a>
        </motion.div>
      ...
      <section id="discover" ref={targetRef} className="relative h-[300vh] w-full">
        <div className="sticky top-0 h-screen flex items-center overflow-hidden">
          <motion.div style={{ x }} className="flex gap-8 px-4 md:px-24 w-max">
            ...
            <div className="w-[85vw] md:w-[800px] h-[500px] shrink-0 bg-white/[0.04] rounded-3xl border border-white/10 shadow-2xl shadow-black/40 overflow-hidden flex flex-col md:flex-row group">
              <div className="p-8 md:p-12 md:w-1/2 flex flex-col justify-center z-10 relative">
                <div className="w-12 h-12 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center mb-6">
                  <Box className="w-6 h-6 text-odoo-300" />
                </div>
                <h2 className="text-3xl font-extrabold text-white mb-4 tracking-tight">Asset Registration & Directory</h2>
                ...
                <ul className="mt-8 space-y-3">
                  <li className="flex items-center gap-3 text-sm font-semibold text-slate-200">
                    <CheckCircle2 className="w-4 h-4 text-odoo-300" /> Auto-generated Asset Tags
                  </li>
                  <li className="flex items-center gap-3 text-sm font-semibold text-slate-200">
                    <CheckCircle2 className="w-4 h-4 text-odoo-300" /> Full History & Audit Trail
                  </li>
                </ul>
              </div>

              <div className="hidden md:flex md:w-1/2 bg-white/[0.02] relative overflow-hidden items-center justify-center p-8 border-l border-white/10">
                <div className="absolute top-0 right-0 w-64 h-64 bg-odoo-500/30 rounded-full blur-3xl opacity-60 transform group-hover:scale-110 transition-transform duration-700" />

                {/* Mock UI (kept light, like a real product screenshot floating in space) */}
                <div className="relative w-full max-w-sm bg-white rounded-2xl shadow-2xl shadow-black/40 border border-slate-200 p-6 transform group-hover:-translate-y-2 transition-transform duration-500">
            ...
            <div className="w-[85vw] md:w-[800px] h-[500px] shrink-0 bg-white/[0.04] rounded-3xl border border-white/10 shadow-2xl shadow-black/40 overflow-hidden flex flex-col md:flex-row group">
              <div className="p-8 md:p-12 md:w-1/2 flex flex-col justify-center z-10 relative">
                <div className="w-12 h-12 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center mb-6">
                  <ArrowRightLeft className="w-6 h-6 text-odoo-300" />
                </div>
                <h2 className="text-3xl font-extrabold text-white mb-4 tracking-tight">Conflict-Free Allocations</h2>
                <p className="text-slate-300 font-medium leading-relaxed">
                ...
                <ul className="mt-8 space-y-3">
                  <li className="flex items-center gap-3 text-sm font-semibold text-slate-200">
                    <CheckCircle2 className="w-4 h-4 text-odoo-300" /> Real-time Conflict Blocking
                  </li>
                  <li className="flex items-center gap-3 text-sm font-semibold text-slate-200">
                    <CheckCircle2 className="w-4 h-4 text-odoo-300" /> Hand-off Approvals
                  </li>
                </ul>
              </div>

              <div className="hidden md:flex md:w-1/2 bg-white/[0.02] relative overflow-hidden items-center justify-center p-8 border-l border-white/10">
                <div className="absolute bottom-0 left-0 w-64 h-64 bg-rose-500/25 rounded-full blur-3xl opacity-60 transform group-hover:scale-110 transition-transform duration-700" />

                {/* Mock UI */}
                <div className="relative w-full max-w-sm bg-white rounded-2xl shadow-2xl shadow-black/40 border border-rose-200 p-6 transform group-hover:-translate-y-2 transition-transform duration-500">
            ...
            <div className="w-[85vw] md:w-[800px] h-[500px] shrink-0 bg-white/[0.04] rounded-3xl border border-white/10 shadow-2xl shadow-black/40 overflow-hidden flex flex-col md:flex-row group">
              <div className="p-8 md:p-12 md:w-1/2 flex flex-col justify-center z-10 relative">
                <div className="w-12 h-12 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center mb-6">
                  <CalendarClock className="w-6 h-6 text-odoo-300" />
                </div>
                <h2 className="text-3xl font-extrabold text-white mb-4 tracking-tight">Shared Resource Booking</h2>
                <p className="text-slate-300 font-medium leading-relaxed">
                ...
                <ul className="mt-8 space-y-3">
                  <li className="flex items-center gap-3 text-sm font-semibold text-slate-200">
                    <CheckCircle2 className="w-4 h-4 text-odoo-300" /> Smart Overlap Validation
                  </li>
                  <li className="flex items-center gap-3 text-sm font-semibold text-slate-200">
                    <CheckCircle2 className="w-4 h-4 text-odoo-300" /> Automated Reminders
                  </li>
                </ul>
              </div>

              <div className="hidden md:flex md:w-1/2 bg-white/[0.02] relative overflow-hidden items-center justify-center p-8 border-l border-white/10">
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-amber-500/25 rounded-full blur-3xl opacity-60 transform group-hover:scale-125 transition-transform duration-700" />

                {/* Mock UI */}
                <div className="relative w-full max-w-sm space-y-3 transform group-hover:-translate-y-2 transition-transform duration-500">
                  <div className="bg-white rounded-xl shadow-lg shadow-black/30 border border-slate-200 p-4 flex items-center justify-between opacity-50 grayscale">
                  ...
                  <div className="bg-white rounded-xl shadow-2xl shadow-black/40 border-2 border-odoo-500 p-4 flex items-center justify-between relative scale-105 z-10">
                  ...
                  <div className="bg-white rounded-xl shadow-lg shadow-black/30 border border-slate-200 p-4 flex items-center justify-between">
            ...
            <div className="w-[85vw] md:w-[800px] h-[500px] shrink-0 bg-white/[0.04] rounded-3xl border border-white/10 shadow-2xl shadow-black/40 overflow-hidden flex flex-col md:flex-row group">
              <div className="p-8 md:p-12 md:w-1/2 flex flex-col justify-center z-10 relative">
                <div className="w-12 h-12 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center mb-6">
                  <ShieldCheck className="w-6 h-6 text-odoo-300" />
                </div>
                <h2 className="text-3xl font-extrabold text-white mb-4 tracking-tight">Structured Audits</h2>
                <p className="text-slate-300 font-medium leading-relaxed">
                ...
                <ul className="mt-8 space-y-3">
                  <li className="flex items-center gap-3 text-sm font-semibold text-slate-200">
                    <CheckCircle2 className="w-4 h-4 text-odoo-300" /> Discrepancy Reporting
                  </li>
                  <li className="flex items-center gap-3 text-sm font-semibold text-slate-200">
                    <CheckCircle2 className="w-4 h-4 text-odoo-300" /> Status Auto-updates
                  </li>
                </ul>
              </div>

              <div className="hidden md:flex md:w-1/2 bg-white/[0.02] relative overflow-hidden items-center justify-center p-8 border-l border-white/10">
                <div className="absolute top-0 right-0 w-64 h-64 bg-odoo-500/30 rounded-full blur-3xl opacity-60 transform group-hover:-translate-x-8 transition-transform duration-700" />
      ...
      <section className="relative z-10 py-20 border-y border-white/10">
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap justify-center items-center gap-12 md:gap-24 opacity-70 hover:opacity-100 transition-all duration-500">
            <span className="text-2xl font-extrabold text-slate-200">AcmeCorp</span>
            <span className="text-2xl font-black text-slate-200 tracking-tighter">Global<span className="text-odoo-300">Dynamics</span></span>
            <span className="text-2xl font-bold text-slate-200 font-serif">Stark Ind.</span>
            <span className="text-2xl font-extrabold text-slate-200 uppercase tracking-widest">Initech</span>
            <span className="text-2xl font-medium text-slate-200 italic">Soylent</span>
          </div>
        </div>
      </section>
      ...
      <section id="modules" className="relative z-10 py-32">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-slate-300 max-w-2xl mx-auto font-medium">Reduce manual inefficiencies with real-time visibility into who holds what, where it is, and its condition.</p>
          </div>

          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white/[0.04] p-10 rounded-[2rem] border border-white/10 shadow-xl shadow-black/20 hover:bg-white/[0.07] hover:border-white/20 transition-all duration-300 group">
              <div className="w-16 h-16 bg-white/5 border border-white/10 rounded-2xl flex items-center justify-center mb-8 group-hover:scale-110 transition-transform">
                <Box className="w-8 h-8 text-odoo-300" />
              </div>
              <h3 className="text-2xl font-bold text-white mb-4">Asset Registration & Tracking</h3>
              <p className="text-slate-300 leading-relaxed font-medium">Track assets through a flexible lifecycle (Available, Allocated, Reserved, Under Maintenance, Lost, Retired, Disposed) with automatic state transitions.</p>
            </div>

            <div className="bg-white/[0.04] p-10 rounded-[2rem] border border-white/10 shadow-xl shadow-black/20 hover:bg-white/[0.07] hover:border-white/20 transition-all duration-300 group">
              <div className="w-16 h-16 bg-white/5 border border-white/10 rounded-2xl flex items-center justify-center mb-8 group-hover:scale-110 transition-transform">
                <CalendarClock className="w-8 h-8 text-odoo-300" />
              </div>
              <h3 className="text-2xl font-bold text-white mb-4">Shared Resource Booking</h3>
              <p className="text-slate-300 leading-relaxed font-medium">Book shared resources like meeting rooms, vehicles, and equipment by time slot, backed by strict overlap validation to prevent double-booking.</p>
            </div>

            <div className="bg-white/[0.04] p-10 rounded-[2rem] border border-white/10 shadow-xl shadow-black/20 hover:bg-white/[0.07] hover:border-white/20 transition-all duration-300 group">
              <div className="w-16 h-16 bg-white/5 border border-white/10 rounded-2xl flex items-center justify-center mb-8 group-hover:scale-110 transition-transform">
                <Wrench className="w-8 h-8 text-odoo-300" />
              </div>
              <h3 className="text-2xl font-bold text-white mb-4">Maintenance Workflows</h3>
              <p className="text-slate-300 leading-relaxed font-medium">Route maintenance requests through a structured approval workflow before repair work starts. Asset status auto-updates dynamically.</p>
            </div>

            <div className="bg-white/[0.04] p-10 rounded-[2rem] border border-white/10 shadow-xl shadow-black/20 hover:bg-white/[0.07] hover:border-white/20 transition-all duration-300 group">
              <div className="w-16 h-16 bg-white/5 border border-white/10 rounded-2xl flex items-center justify-center mb-8 group-hover:scale-110 transition-transform">
                <ShieldCheck className="w-8 h-8 text-odoo-300" />
              </div>
              <h3 className="text-2xl font-bold text-white mb-4">Scheduled Audit Cycles</h3>
              <p className="text-slate-300 leading-relaxed font-medium">Run structured audit cycles with assigned auditors who verify asset conditions, automatically generating discrepancy reports for missing items.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="features" className="relative z-10 py-32 border-t border-white/10">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-slate-300 max-w-2xl mx-auto font-medium">Clean architecture and user-centric workflows designed to manage organizational assets flawlessly.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div key={i} className="p-8 rounded-2xl bg-white/[0.04] border border-white/10 hover:bg-white/[0.07] hover:border-white/20 transition-all">
                <feat.icon className="w-8 h-8 text-odoo-300 mb-6" />
      ...
      <section className="relative z-10 py-32 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-[#714B67]/25 to-transparent opacity-60 pointer-events-none" />
        <div className="max-w-4xl mx-auto px-4 relative z-10 text-center">
          <h2 className="text-4xl md:text-5xl font-extrabold text-white mb-6 tracking-tight [text-shadow:0_2px_20px_rgba(0,0,0,0.5)]">Built for Any Industry</h2>
          ...
          <Link href="/login" className="inline-block px-8 py-4 rounded-full bg-white text-slate-900 hover:bg-slate-100 font-bold shadow-lg shadow-black/30 transition-all">
            See the Live Demo
          </Link>
        </div>
      </section>
      ...
      <section className="relative z-10 py-32">
        <div className="max-w-3xl mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-extrabold text-white mb-6 tracking-tight [text-shadow:0_2px_20px_rgba(0,0,0,0.5)]">Frequently Asked Questions</h2>
            <p className="text-lg text-slate-300 font-medium">Find quick answers to common questions about AssetFlow workflows.</p>
          </div>
          ...
          <div className="space-y-4">
            {[
              ...
              <details key={idx} className="group bg-white/[0.04] rounded-2xl border border-white/10 overflow-hidden hover:bg-white/[0.06] transition-colors">
                ...
                <div className="text-slate-300 p-6 pt-0 font-medium leading-relaxed">
                  {faq.a}
                </div>
              </details>
            ))}
      ...
      {/* 6. Final CTA (a purple glass panel floating on the starfield) */}
      <section className="relative z-10 py-32 px-4">
        <div className="relative max-w-5xl mx-auto rounded-[2.5rem] overflow-hidden border border-white/10 shadow-2xl shadow-black/50">
          ...
          <div className="relative z-10 text-center py-24 px-6">
            ...
            <Link href="/login" className="inline-block px-10 py-5 rounded-full bg-white hover:bg-slate-100 text-[#714B67] font-extrabold text-lg shadow-2xl shadow-black/30 transition-all transform hover:-translate-y-1">
      ...
      <footer className="relative z-10 border-t border-white/10 py-16">
        <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <div className="flex flex-wrap gap-8 text-sm font-semibold text-slate-400 justify-center">
          ...
          <p className="text-sm text-slate-500 font-medium">© 2026 AssetFlow. All rights reserved.</p>
        </div>
      </footer>
